...
if exists('g:neovide')
    let g:neovide_transparency=0.83
    "hi Normal guibg=#070707
    "hi Normal guibg=#1a1a1a
    "hi normal guibg=#23282b
    hi normal guifg=#a3a3a3 guibg=#1e2225
else
    pass
...
hi semshiParameter ctermfg=75 gui=italic guifg=#898989
hi semshiImported cterm=bold ctermfg=214 guifg=#929669
...
hi Statement guifg=#a38d68
hi pythonImport guifg=#a38d68
