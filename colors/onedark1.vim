...
if v:true
    ...
    " Normal Mode
    highlight Tabline guibg=#404040
    ...
    highlight semshiImported guifg=#E06C75 gui=none
    highlight semshiAttribute guifg=#56B6C2 gui=none
    highlight semshiSelected guifg=none guibg=#5c6370

    highlight Visual guibg=#3d4452
    ...
    augroup Colors
        autocmd!
        autocmd InsertEnter * highlight ColorColumn guibg=#31353f
        autocmd InsertEnter * highlight VertSplit   guifg=#31353f guibg=#31353f
        autocmd InsertEnter * highlight lualine_c_inactive  guifg=#ebdbb2 guibg=#31353f
        autocmd InsertEnter * highlight StatusLineNC  guifg=#31353f guibg=#31353f
        autocmd InsertEnter * highlight TabLineFill  guifg=#31353f guibg=#31353f
        autocmd InsertEnter * highlight TabLineSel  gui=bold guifg=#31353f guibg=#31353f
        autocmd InsertEnter * highlight TabLineSel  gui=bold guifg=#282828 guibg=#83a598

        autocmd InsertLeave * highlight ColorColumn guibg=#31353f
        autocmd InsertLeave * highlight VertSplit   guifg=#31353f guibg=#31353f
        autocmd InsertLeave * highlight lualine_c_inactive  guifg=#ebdbb2 guibg=#31353f
        autocmd InsertLeave * highlight StatusLineNC  guifg=#31353f guibg=#31353f
        autocmd InsertLeave * highlight TabLineFill  guifg=#31353f guibg=#31353f
